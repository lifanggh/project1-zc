...
<html>
				...
				<div class="layui-col-md12" style="height: 300px;background-color: #f0f0f0;">
					<div style="float: left;width: 50%;height:100%;background-color: aqua;">
						<div class="layui-carousel" id="test1">
						  <div carousel-item>
						    <div><img src="img/lb/16.jpg" alt="" class="img-thumbnail"></div>
						    <div><img src="img/lb/17.jpg" alt="" class="img-thumbnail"></div>
						    <div><img src="img/lb/18.jpg" alt="" class="img-thumbnail"></div>
						    <div><img src="img/lb/20.jpg" alt="" class="img-thumbnail"></div>
						    <div><img src="img/lb/4.jpg" alt="" class="img-thumbnail"></div>
						  </div>
						</div>
					</div>
					<div style="float: right;width: 50%;height:100%;background-color:gray;">
						<center>
	...
	function setyzm(){
		$.ajax({
			url:"<%=path%>/login/getYzm.do",/*获取验证码 */
			type:"post",
			dataType:"json",
	...
	function up(){
		var data = new Date();
		$("#img").attr("src","<%=path%>/login/yzm.do?date="+data);/*获取验证码放到登录页面*/
		setyzm();
	}
